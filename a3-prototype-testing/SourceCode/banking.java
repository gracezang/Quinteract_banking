...
public class banking {
	...
	private static ArrayList<String> readFile(String fileName) throws FileNotFoundException {
		...
		for (int i = 0; i < (length-1); i+=3) {
			String newString = contentList[i] + "!" + contentList[i+1] + "!" + contentList[i+2];
...
//		}
	...
	public static void main(String args[]) throws IOException {
		...
		for (String i : accountList) {
			...
			accounts a = new accounts(Integer.parseInt(newList[0]), newList[1],Double.parseDouble(newList[2]));
